...
public class ImproveRationality : SelfAction
{
    ...
    public override string baseDescription => "You can always work on yourself, this IAgent would like to improve their rationality.";

    protected override float baseTime => 4f;
    protected override float baseEnergy => 15f;
    protected override float complexity => 10f;
    protected override float baseUtility => 32f;
    ...
    protected override void innerPerformAction(float percentComplete)
    {
        ...
        string description = performer.fullName + " spent " + (percentMulti*timeToComplete).ToString("0.00") + " hours improving their rationality.";
